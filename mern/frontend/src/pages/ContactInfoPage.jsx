			...
			<div className="container mx-auto px-4 py-12">
				...
				>
					...
					<p className="text-xl text-gray-300 max-w-2xl mx-auto">
						Get in touch with STRIKERS NO TITLE CARS. We're here to help you find your perfect vehicle.
					</p>
				</motion.div>
						...
						<div className="space-y-6">
							...
							<div className="flex items-start space-x-4">
								...
								<div>
									...
									<p className="text-gray-300 text-lg">info@strikersauto.com</p>
							...
							<div className="flex items-start space-x-4">
								...
								<div>
									...
									<p className="text-gray-400 text-sm mt-2">Holiday hours may vary</p>
								</div>
							</div>
						</div>
					</motion.div>
						...
						<div className="space-y-6">
							<div className="bg-gray-700 p-6 rounded-lg">
								...
								<p className="text-gray-300 mb-4">
									Call us directly for immediate support or visit our showroom during business hours.
								</p>
								<a
							...
							<div className="bg-gray-700 p-6 rounded-lg">
								<h3 className="text-lg font-semibold text-white mb-3">Send us an Email</h3>
								<p className="text-gray-300 mb-4">
									For detailed inquiries or to schedule a viewing, send us an email.
								</p>
								<a
									href="mailto:info@strikersauto.com"
							...
							<div className="bg-gradient-to-r from-red-600 to-red-700 p-6 rounded-lg">
								<h3 className="text-lg font-semibold text-white mb-3">Special Services</h3>
				...
				>
					<div className="bg-gray-800 rounded-lg p-8 border border-gray-700 max-w-4xl mx-auto">
						<h3 className="text-2xl font-bold text-white mb-4">Why Choose STRIKERS?</h3>
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-gray-300">
							<div>
								<h4 className="font-semibold text-red-400 mb-2">Expert Service</h4>
								<p>Over 10 years of experience in the automotive industry</p>
							</div>
							<div>
								<h4 className="font-semibold text-red-400 mb-2">Quality Vehicles</h4>
								<p>Carefully inspected and tested vehicles for your peace of mind</p>
							</div>
							<div>
								<h4 className="font-semibold text-red-400 mb-2">Customer First</h4>
