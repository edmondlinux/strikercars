		...
		<div className='min-h-screen bg-gray-900 py-8 md:py-16'>
			<div className='mx-auto max-w-4xl px-4'>
				...
				<div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
					...
					>
						...
						<div className='space-y-3'>
							...
							<div>
								...
								<p className='text-red-400 font-bold text-2xl'>${product.price.toLocaleString()}</p>
							</div>
							<div>
								<p className='text-gray-400 text-sm'>Description</p>
								<p className='text-gray-300 text-sm'>{product.description || "Well-maintained vehicle with clean history."}</p>
							</div>
						</div>

						{/* Contact Information */}
						<div className='mt-6 pt-6 border-t border-gray-700'>
							<h3 className='text-lg font-semibold text-white mb-4'>Our Contact Info</h3>
							<div className='space-y-3'>
								...
								<div className='flex items-center space-x-3'>
									...
									<div>
										<p className='text-white font-medium'>info@strikersauto.com</p>
					...
					>
						<h2 className='text-xl font-bold text-white mb-6'>Send Your Inquiry</h2>
